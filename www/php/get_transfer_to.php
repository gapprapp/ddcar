<?php
    ...
    if(isset($_POST['date'])){
        ...
        ON t.branch_id = w.ware_id WHERE t.date_time BETWEEN '$date' AND '$date_to' AND t.remark NOT LIKE '%$txt%' LIMIT $start,30";
        ...
        AND t.remark NOT LIKE '%$txt%' ORDER BY t.tf_id DESC LIMIT $start,30";
    }else{
        $query = "SELECT t.tf_id,w.ware_name,t.date_time FROM transfer_record t INNER JOIN warehouse_detail w
        ON t.branch_id = w.ware_id WHERE t.remark NOT LIKE '%$txt%' ORDER BY t.tf_id DESC LIMIT $start,30";
    }    
